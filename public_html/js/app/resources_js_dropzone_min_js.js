(self["webpackChunkmasara_design"] = self["webpackChunkmasara_design"] || []).push([["resources_js_dropzone_min_js"],{
...
!function () {
  ...
  function s(e, i) {
    return !i || "object" != ((n = i) && n.constructor === Symbol ? "symbol" : _typeof(n)) && "function" != typeof i ? t(e) : i;
    var n;
  }
  var u;
  function c(e) {
  ...
  var p = {
    ...
    f = function (n) {
      ...
      return l(o, n), r(o, [{
        ...
        value: function value() {
          var e = function e(_e) {
              var t = !0,
                ...
                n = void 0;
              try {
                for (var r, a = _e[Symbol.iterator](); !(t = (r = a.next()).done); t = !0) {
                  var o = r.value;
        ...
        value: function value(e, t, i, n, r, a, o) {
          var l = this,
          ...
          return o && (s.crossOrigin = o), r = "from-image" != getComputedStyle(document.body).imageOrientation && r, s.onload = function () {
            ...
            return "undefined" != typeof EXIF && null !== EXIF && r && (u = function u(e) {
        ...
        key: "_transformFiles",
        value: function value(e, t) {
          for (var i = this, n = function n(_n) {
              i.options.transformFile.call(i, e[_n], function (i) {
                r[_n] = i, ++a === e.length && t(r);
              });
      ...
      var t = function t(_t) {
        return function () {
          var i = [],
            ...
            a = void 0;
          try {
            for (var o, l = _t[Symbol.iterator](); !(n = (o = l.next()).done); n = !0) {
              var s = o.value;
  ...
  var y = function y(e, t, i, n, r, a, o, l, s, u) {
      var c = function (e) {
        e.naturalWidth;
