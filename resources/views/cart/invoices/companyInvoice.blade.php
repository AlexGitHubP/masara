  ...
  <div class="table-section bill-tbl w-100 mt-10">
    <table class="table w-100 mt-10">
        ...
        <tr>
            <td>
                <div class="box-text">
                    <p><strong>Nume: </strong>{{ $shopDetails->company_name }}</p>
                    ...
                    <p><strong>Adresă: </strong>{{ $shopDetails->company_address }}</p>
            ...
            <td>
                <div class="box-text">
                    <p><strong>Nume: </strong>{{ $orderDetails['company_name'] }}</p>
                    <p><strong>CUI: </strong>{{ $orderDetails['company_vat_type'] }} {{ $orderDetails['company_cui'] }}</p>
                    <p><strong>Nr. registrul comerțului: </strong>{{ $orderDetails['company_j'] }}{{ $orderDetails['company_nr'] }}/{{ $orderDetails['company_series'] }}/{{ $orderDetails['company_year'] }} </p>
                    <p><strong>Adresă: </strong>{{ $orderDetails['address'] }}</p>
