    ...
    <div class='filter-tab'>
        ...
        <div class='actions-tab'>
            <ul class='action-controls'>
                <li>
                    <a href="/admin/seo/create" class='iconControl'>
					<span>
        ...
        <div class='listing-elements-hold'>
            @foreach($items as $key => $item)
                <div class='listing-element {{ $loop->last ? 'lastElement' : '' }}'>
                    ...
                    <div class='listing-box flex07'>
                        <p><a href='/admin/seo/{{$item->id}}/edit'>{{ $item->url }}</a></p>
                    </div>
                    <div class='listing-box flex05'>
                        <p><a href='/admin/seo/{{$item->id}}/edit'>{{ $item->slug }}</a></p>
                    </div>
                    ...
                    <div class='listing-box flex02 alignCenter'>
                        <div class='more-actions-tab'>
                            ...
                            <ul class='more-list'>
                                <li>
                                    <form action="/admin/seo/{{ $item->id }}" method="POST">@method('DELETE') @csrf <input type="submit" value="Șterge"/></form>
                                </li>
                            </ul>
                        </div>
                    </div>
