...
<div class="content-container">
    <div class="cms-body">
	<form method="POST" action='/admin/productsCategories/'>
		@csrf
		...
		<div class='flex-inputs flex100'>
			...
			<div class="input-element textarea">
				...
				<textarea name="category_description" id="category_description" value=''></textarea>
			</div>
			<div class="input-element">
				<label for="category_status">Status produs</label>
				<select name='category_status' id='category_status' value="">
