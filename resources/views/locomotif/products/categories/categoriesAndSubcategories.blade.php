...
<form id='addProductsCategoriesAndSubcategories' method="POST" action='' class='spaced-form'>
    ...
    <input data-tableName='' data-formID='addProductsCategoriesAndSubcategories' data-submitUrl='/admin/productsCategories/addCategoriesAndSubcategories' class='general-btn ajaxSubmit' type="submit" value="Asociază categoriile">
</form>
