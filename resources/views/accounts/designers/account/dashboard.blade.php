        ...
        <div class='large-container'>
            <div class='dashboard-flex'>
                ...
                <div class='dashboard-right'>
                    ...
                    <div class='top-designer-products'>
                        <h2>Top produse</h2>
                        @if (count($products) > 0)
                            <div class='designer-top-products'>
                            ...
                            <div class='more-products-hold'>
                                <a href="">Vezi toate produsele tale</a>
                            </div>
                        @else
    ...
    @if($isFirstLogin)
        <div class='initial-login-modal'>
            <div class='modal-element'>
                ...
                <p class="centered">Contul tău va fi activat după verificarea datelor de companie.</p>
                <p class="centered"><strong><a href="{{ url('/cont-designer/administrativ.html') }}">Aici</a></strong> poți adăuga datele de companie.</p>
            </div>
        </div>
    @endif
@stop
