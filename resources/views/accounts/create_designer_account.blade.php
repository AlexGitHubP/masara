...
{{--            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec tempor, diam in eleifend vehicula, quam lacus elementum nunc, eget tincidunt dui neque ut diam.</p>--}}
            <form action="" method='POST' id='creeateDesignerAccountForm'>
                @csrf
                ...
                <div class="input-hold checkbox-hold">
                    <label for="is_company">Dețin formă juridică</label>
                    <input type="checkbox" name="is_company" id="is_company" value="">
                ...
                <div class='create-account-btn-hold relative'>
                    <input type="submit" value='Creează cont' id='creeateDesignerAccount' class='general-btn' data-endpoint='/login/creeaza-cont-designer.html' data-method='POST' data-form='creeateDesignerAccountForm'>
                    <div class='loader'>
